...
export const RPC_METHODS = [
  ...
  { method: 'agentcli.targets', summary: 'List compile targets and their declared capabilities.' },
  { method: 'agentcli.paths', summary: 'Return resolved agentcli home paths.' },
  ...
  { method: 'agentcli.audit', summary: 'Read sanitized local execution audit records.' },
  { method: 'agentcli.approvals.list', summary: 'List local approval records by status.' },
  { method: 'agentcli.registry.list', summary: 'List reusable manifests in the local registry.' },
  { method: 'agentcli.registry.show', summary: 'Return a named manifest from the local registry.' },
  ...
  { method: 'agentcli.authorizationProof.verify', summary: 'Verify a task authorization proof without executing the task.' },
