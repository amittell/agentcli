...
export const ERROR_CODES = Object.freeze([
  ...
  'spiffe_trust_required',
  'spiffe_algorithm_unsupported',
  'spiffe_svid_expired',
  'spiffe_svid_not_active',
  'spiffe_audience_mismatch',
  'spiffe_issuer_mismatch',
  'spiffe_signature_invalid',
  'spiffe_svid_unavailable',
  'spiffe_refresh_unavailable',
  'resolution_failed',
  'token_not_found',
  'token_file_empty',
